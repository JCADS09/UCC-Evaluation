...
$user = $_SESSION['ID'];
	...
	$query = mysqli_query($con,"SELECT * FROM 20231stsemcongress where sno = '$id' ");
...
<div style="margin-left:.5in;margin-right:.5in;margin-top:.1in;margin-bottom:.1in;line-height:1mm;">
		...
		<p><center><b>UCC Evaluation System</b></center></p>

		  </div>
		  <div class="row">
		  <div class="col-md-12">
		  <center><p><b><h4>UNIVERSITY OF CALOOCAN CITY</h4></b></p></center>
		  </div>
          </div>
          <div class="row">
		  <div class="col-md-12">
		...
		include '../db.php';
		$id = $_GET['id'];
		$sql = mysqli_query($con,"SELECT * from 20231stsemcongress where sno = '$id'");
		...
		<?php } ?>
          ...
          <p style="">
          <?php
		$sql1 = mysqli_query($con, "SELECT sy1, sy2 FROM 20231stsemcongress
        WHERE sno = '$id'");
