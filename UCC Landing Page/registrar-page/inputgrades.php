...
<script>
    ...
    <div class="row p-t-20">
        ...
        <label><b>&nbsp&nbsp&nbsp&nbsp&nbspStudent No.:&nbsp</b></label>
                                ...
                                <label><b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspMidterm:&nbsp</b></label>
                                <input type="text" style="width:10%;" name="MT[${lastIndex + 1}]" placeholder="MT" autocomplete="off">
                                <label><b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspFinal Term:&nbsp</b></label>
                                <input type="text" style="width:10%;" name="FT[${lastIndex + 1}]" placeholder="FT" autocomplete="off">
                                <label><b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspFinal Grade:&nbsp</b></label>
                                <input type="text" style="width:10%;" name="FG[${lastIndex + 1}]" placeholder="FG" autocomplete="off">
