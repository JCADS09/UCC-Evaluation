...
<body>
 ...
 <div class="header-top-area" style="background-color: rgb(17, 112, 22);">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li class="active">
                            <a href="studentlist_gradingsheet.php">
    ...
    <?php
include 'db.php';
$query = "SELECT sno, CONCAT(sname, ', ', fname, ' ', mname) AS Name, course, year1 AS year, section AS section, status1 AS status FROM 202120221stsem";
$result = mysqli_query($con, $query);
?>
    <div class="panel-container">
    <center><h1> UCC STUDENT LIST</h1> </center>
    <!-- <label style="font-family:Arial;font-size:14px;">
        <input type="radio" name="candidates" value="latin" id="LatinHonor"> Latin Honor
        <input type="radio" name="candidates" value="dean" id="DeanLister"> Dean Lister
        <input type="radio" name="candidates" value="def" id="Defficiency"> Defficiency
    </label> -->
        ...
        <table id="students" class="display">
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<td><center><a class="btnView" href="gradingsheet.php?id=' . $row['sno'] . '"> View Records </a></center></td>';
                    echo '</tr>';
                    $count++;
                }
                ?>
