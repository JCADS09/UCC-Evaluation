    ...
    <div class="container">
        <div class="forms-container">
            ...
            <form action="#" method="POST" name="login"class="sign-in-form" >
                ...
                <button type="submit" value="Login" name="login" class="btn solid" onclick="showDialog()">Login</button>
            </form>
...
<div class="input-field">
    <i class='bx bxs-user'></i>
    <input type="text" id="Middlename" name="Middlename" placeholder="Middle Name" required autofocus>
</div>
...
<div class="additional-input-field hidden">
    <img src="images/add_pic.png" class="image clickable-image" alt="Click to upload" id="profile-pic-preview">
...
<button type="button" class="btn solid next-button" onclick="submitForm()">Next</button>
            ...
            <div class="panel left-panel">
                <div class="content">
                    <h1>UCC EVALUATION</h1>
                     <p>
                    This is the Evaluation System of University of Caloocan City. The purpose of the system is to automate the current manual process of evalaution inside the organization.
                    </p>
                     <h3>New here?</h3><br>
