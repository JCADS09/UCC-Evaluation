...
<body>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        <li class="tab"><a href="../misnav.php"><img src="../system-img/home.png" width="28"
                                    height="27"></i> Home</a>
                        </li>
                        <li class="tab">
            ...
            <div class="modal-body">
                <form method="POST" action="submitstudent.php">
                    ...
                    <div>
                        ...
                        <input type="date" style="width:13%;" name="date_enrol" placeholder="1/11/2000"
                            autocomplete="off">

                        <input type="hidden" name="campus" id="selectedCampus">

                        <b><label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                Campus:&nbsp</label></b>
                    ...
                    <div class="row p-t-20">
                        <div class="col-md-3">
                            ...
                            <input type="text" style="width:50%;" name="sno" placeholder="Student no."
                                autocomplete="off" onkeypress="numOnly(event)">
                        </div>
                    ...
                    <div class="row p-t-20">
                        <div class="col-md-4">
                            ...
                            <input type="text" style="width:60%;" name="sname" placeholder="Surname" autocomplete="off"
                                onkeypress="lettersOnly(event)" oninput="upperCase(this)">
                        </div>

                        <div class="col-md-4">
                            <label><b>First Name:&nbsp</b></label>
                            <input type="text" style="width:60%;" name="fname" placeholder="First Name"
                                autocomplete="off" onkeypress="lettersOnly(event)" oninput="upperCase(this)">
                        </div>

                        <div class="col-md-4">
                            <label><b>Middle Name:&nbsp</b></label>
                            <input type="text" style="width:60%;" name="mname" placeholder="Middle Name"
                                autocomplete="off" onkeypress="lettersOnly(event)" oninput="upperCase(this)">
                        </div>
                    </div>
                    ...
                    <div class="row p-t-20">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" style="width:40%;" name="course" placeholder="e.g. BSIS"
                                autocomplete="off" onkeypress="lettersOnly(event)" oninput="upperCase(this)">
                        </div>
                    ...
                    <div class="row p-t-20">
                        <div>
                            ...
                            <input type="text" style="width:40%;" name="desc[]" placeholder="Subject Description"
                                autocomplete="off" oninput="upperCase(this)">

                            <label><b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspSubj. Code:&nbsp</b></label>                           
                            <input type="text" style="width:10%;" name="scode[]" placeholder="Subj. Code"
                                autocomplete="off" oninput="upperCase(this)">
                            <label><b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspUnits:&nbsp</b></label>
                            <input type="text" style="width:10%;" name="unit[]" placeholder="Units" autocomplete="off" oninput="oneDigit(this)" onkeypress="numOnly(event)">
                    ...
                    <div>
                        <button type="submit" style="margin-left:85%;width:7%;"> Add
    ...
    <div class="row p-t-20">
        <div>
            <label><b>&nbsp&nbsp&nbsp&nbsp&nbspSubject Description:&nbsp</b></label>
            <input type="text" style="width:40%;" name="desc[${lastIndex + 1}]" placeholder="Subject Description" autocomplete="off" oninput="upperCase(this)" on>
            <label><b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspSubj. Code:&nbsp</b></label>
            <input type="text" style="width:10%;" name="scode[${lastIndex + 1}]" placeholder="Subj. Code" autocomplete="off" oninput="upperCase(this)">
            <label><b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspUnits:&nbsp</b></label>
            <input type="text" style="width:10%;" name="unit[${lastIndex + 1}]" placeholder="Units" autocomplete="off" oninput="oneDigit(this)" onkeypress="numOnly(event)">
