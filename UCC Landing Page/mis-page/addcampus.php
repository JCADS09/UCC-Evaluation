...
<body>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        <li>
                            <a href="../misnav.php"><img src="../system-img/home.png" width="28" height="27"></i> Dashboard</a>
                        </li>
                        <li class="tab">
    ...
    <?php if (isset($_SESSION['message'])) : ?>
            ...
            <?php echo "<h4>".$_SESSION['message']."</h4>"; ?></div>
            <?php unset($_SESSION['message']);?>
        <?php endif; ?>
        <div style="margin-bottom:15px;">
            Campus: <input type="text" name="campus_name" style="width:695px;" placeholder="Enter Campus Name"></input>
        </div>
        <div>
            Address: <input type="text" name="campus_location" style="width:695px;" placeholder="Enter Campus Address"></input>
        </div>
        <div>
            <br>
