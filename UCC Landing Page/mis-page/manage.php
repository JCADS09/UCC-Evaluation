...
<body>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li><a data-toggle="active" href="#M-Accounts"><img src="../system-img/settings.png" width="22" height="22"> Manage Accounts</a>
                        </li> 
    ...
    <!-- Main Menu area End-->
    <h1 style="margin-left:20%;"> Manage Campus </h1>
    <form method="post" action="savecourse.php">
        <div>
            <!-- FETCH CAMPUS NAME -->
</div>
        <div>
            College Department: <input type="text" style="width:622px;" placeholder="College Department"></input>
        </div>
        <div>
            <b>Course</b>
        </div>
        <div>
            Full Description: <input type="text" style="width:320px;" placeholder="e.g. Bachelor of Science in Information System"></input>
            &nbsp&nbsp&nbsp&nbsp&nbspAcronym: <input type="text" style="width:200px;" placeholder="e.g. BSIS"></input>
            &nbsp<button type="button" style="cursor:pointer; color:white; background: green;" onclick="addField()"> + </button>
        </div>
        
        <div>
        <button type="submit" style="margin-left:91%;"> Save <php ?> </button>
</div>
    </form>
    ...
    <!--Script-->
        ...
        function addField() {
            ...
            newDiv.innerHTML = `
                <div>
                    Full Description: <input type="text" style="width:320px;" placeholder="e.g. Bachelor of Science in Information System">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Acronym: <input type="text" style="width:200px;" placeholder="e.g. BSIS">
