            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li><a data-toggle="tab" href="#Home"><img src="../system-img/home.png" width="28" height="27"> Home</a>
                        </li> 
                        <li class="tab">
                        <a href="students.php">
                        ...
                        <li class="active"><a data-toggle="tab" href="#M-Accounts"><img src="../system-img/settings.png" width="22" height="22"></i> Manage Accounts</a>
                        </li>
