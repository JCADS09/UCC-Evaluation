        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    ...
                    <div class="logo-area" style="width:30px; height: 40px;">
                                        ...
                                        <a href="#">
                                            <div class="hd-message-sn">
                                                <div class="hd-message-img">
                                                    <img src="img/post/green.png" alt="" />
                                                </div>
                                                <div class="hd-mg-ctn">
                                                    <h3>David Belle</h3>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        <li class="active"><a data-toggle="tab" href="#Home"><img src="home.png" width="28" height="27"></i> Dashboard</a>
                        </li>
                        <li><a data-toggle="tab" href="#students"><img src="student.png" width="25" height="25"> Student Records</a>
                        </li>
                        <li><a data-toggle="tab" href="#M-Accounts"><img src="settings.png" width="22" height="22"> Import Grades</a>
                        </li> 
                        <li><a data-toggle="tab" href="#M-campus"><img src="campus.png" width="34" height="25"></i> Notification</a>
                        </li> 
